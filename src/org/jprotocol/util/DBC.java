...
{    
    ...
    public interface IDBCCondition
    {
	...
	public static final class DBCError extends AssertionError
    {
        public DBCError(final String msg)
        {
            super(msg);
        }
    }
    ...
    public static IDBCCondition nonNegative(final int value)
    {
        final IDBCCondition condition;
        if (0 <= value)
        {
    ...
    public static IDBCCondition nonNegative(final double value)
    {
        final IDBCCondition condition;
        if (0 <= value)
        {
    ...
    public static IDBCCondition inRange(final int value, final int rangeMin, final int rangeMax)
    {
        final boolean notBellow = (value >= rangeMin);
        final boolean notAbove  = (value <= rangeMax);
    ...
    public static IDBCCondition inRange(final double value, final double rangeMin, final double rangeMax)
    {
        final boolean notBellow = (value >= rangeMin);
        final boolean notAbove  = (value <= rangeMax);
    ...
    public static IDBCCondition notEmpty(final double[] doubleArr)
    {
        final IDBCCondition condition;
    ...
    public static IDBCCondition equalsTrue(final boolean value)
    {
        final IDBCCondition condition;
        if (value) 
        {
    ...
    public static IDBCCondition equalsFalse(final boolean value)
    {
        final IDBCCondition condition;
        if (!value) 
        {
    ...
    public static IDBCCondition getSuccessContractCondition()
    {
        return SUCCESS_CONDITION;
    }
   
    public static IDBCCondition createContractCondition(
            final boolean condition, 
            final String description)
    {
        final class ContractCondition implements IDBCCondition
        {
    ...
    private static void throwContractViolationException(
            ...
            final Object... description) throws Error
    {
        final Error error = new DBCError(createInfo(contractLabel, contract, description));
    ...
    private static boolean foundContractCallStackLocation(
            ...
            final int elementNo)
    {
        final String contractClassName = DBC.class.getCanonicalName();
    ...
    private static final IDBCCondition SUCCESS_CONDITION = createContractCondition(SUCCESS, NO_DESCRIPTION);   
}
